 ...
 */
public class HttpsMessagingHandlerTest extends MessagingHandlerTest {

    private static Message message;

    @BeforeClass
    public static void init() {
        receiverHandler = new HttpsMessagingHandler();
        senderHandler = new HttpsMessagingHandler();
        listenerHandler = new HttpsMessagingHandler();
    }
