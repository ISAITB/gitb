...
import com.gitb.engine.messaging.handlers.layer.application.https.HttpsMessagingHandler;
 ...
 */
@MessagingHandler(name="PeppolAS2Messaging")
public class PeppolAS2MessagingHandler extends HttpsMessagingHandler{
    ...
    private static final Charset CHARSET_ISO88591 = StandardCharsets.ISO_8859_1;
    private static final Charset CHARSET_ASCII    = StandardCharsets.US_ASCII;

    private static final String MODULE_DEFINITION_XML = "/messaging/peppol-as2-messaging-definition.xml";
