	...
	(DataService)->
		...
		template: ''+
			'<div class="form-group">'+
				...
				'<div class="col-xs-7"><input id="shortName" ng-model="domain.sname" class="form-control" type="text"></div>'+
			...
			'<div class="form-group">'+
				...
				'<div class="col-xs-7"><input id="fullName" ng-model="domain.fname" class="form-control" type="text"></div>'+
