	...
	(DataService)->
		...
		template: ''+
			'<div class="form-group">'+
				...
				'<div class="col-xs-7"><input id="id" ng-model="actor.actorId" class="form-control" type="text" required></div>'+
			...
			'<div class="form-group">'+
				...
				'<div class="col-xs-7"><input id="name" ng-model="actor.name" class="form-control" type="text" required></div>'+
