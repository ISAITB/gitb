	...
	(DataService)->
		...
		template: ''+
			'<div class="form-group">'+
				...
				'<div class="col-sm-7"><input id="shortName" ng-model="specification.sname" class="form-control" type="text" autocomplete="off"></div>'+
			...
			'<div class="form-group">'+
				...
				'<div class="col-sm-7"><input id="fullName" ng-model="specification.fname" class="form-control" type="text" autocomplete="off"></div>'+
