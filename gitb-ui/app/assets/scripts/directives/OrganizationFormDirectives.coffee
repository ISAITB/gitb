  ...
  (@DataService)->
    ...
    template: ''+
      '<div class="form-group">'+
        ...
        '<div class="col-xs-7"><input id="sname" ng-model="tbOrganization.sname" class="form-control" type="text" required></div>'+
      ...
      '<div class="form-group">'+
        ...
        '<div class="col-xs-7"><input id="fname" ng-model="tbOrganization.fname" class="form-control" type="text" required></div>'+
