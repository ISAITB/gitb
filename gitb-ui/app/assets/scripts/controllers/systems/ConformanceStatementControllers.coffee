class ConformanceStatementController
  name: 'ConformanceStatementController'
...
class CreateConformanceStatementController
  name: 'CreateConformanceStatementController'
...
@ControllerUtils.register @controllers, EditEndpointConfigurationController
@ControllerUtils.register @controllers, ConformanceStatementDetailController
@ControllerUtils.register @controllers, CreateConformanceStatementController
@ControllerUtils.register @controllers, ConformanceStatementController
