...
object ParameterNames {
  ...
  val FILE_NAME_EXPRESSION = "fileNameExpression"
  val SAMPLES = "samples"
  val API = "api"
  val UPDATES = "updates"
  ...
  val WELCOME_LOGIN_COLOR = "welcomeLoginColor"
  val WELCOME_LOGIN_LABEL_COLOR = "welcomeLoginLabelColor"
  val WELCOME_OPTION_LABEL_COLOR = "welcomeOptionLabelColor"
  val ALERT_INFO_BACKGROUND_COLOR = "alertInfoBackgroundColor"
  val ALERT_INFO_TEXT_COLOR = "alertInfoTextColor"
  val ALERT_INFO_BORDER_COLOR = "alertInfoBorderColor"
