...
class SelfRegOption(_communityId: Long, _communityName: String, _communityDescription: Option[String], _communityEmail: Option[String], _selfRegType: Short, _templates: Option[List[SelfRegTemplate]], _labels: List[CommunityLabels], _customOrganisationProperties: List[OrganisationParameters]) {
  ...
  var communityEmail: Option[String] = _communityEmail
