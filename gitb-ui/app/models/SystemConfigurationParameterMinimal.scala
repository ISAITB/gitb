...
class SystemConfigurationParameterMinimal(var parameterId: Long, var endpointName: String, var parameterName: String, var parameterValue: Option[String], var dependsOn: Option[String], var dependsOnValue: Option[String], var parameterKind: String, var valueContentType: Option[String]) extends WithPrerequisite {
