...
class ErrorPageData(_logoPath: String, _footerLogoPath: String, _versionNumber: String, _defaultLegalNotice: String, _userGuideLink: String, _errorId: String, _testBedHomeLink: String) {
