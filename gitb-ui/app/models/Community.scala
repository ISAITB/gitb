...
class Community(_id:Long, _shortname:String, _fullname:String, _supportEmail:Option[String], _selfRegType: Short, _selfRegToken: Option[String], _selfRegTokenHelpText: Option[String], _selfregNotification: Boolean, _description: Option[String], _selfRegRestriction: Short, _selfRegForceTemplateSelection: Boolean, _selfRegForceRequiredProperties: Boolean, _allowCertificateDownload: Boolean, _allowStatementManagement: Boolean, _allowSystemManagement: Boolean, _domain:Option[Domain]) {
  ...
  def this(_case:Communities, _domain:Option[Domain]) =
    this(_case.id, _case.shortname, _case.fullname, _case.supportEmail, _case.selfRegType, _case.selfRegToken, _case.selfRegTokenHelpText, _case.selfregNotification, _case.description, _case.selfRegRestriction, _case.selfRegForceTemplateSelection, _case.selfRegForceRequiredProperties, _case.allowCertificateDownload, _case.allowStatementManagement, _case.allowSystemManagement, _domain)
  ...
  def toCaseObject:Communities = {
    ...
    Communities(id, shortname, fullname, supportEmail, selfRegType, selfRegToken, selfRegTokenHelpText, selfRegNotification, description, selfRegRestriction, selfRegForceTemplateSelection, selfRegForceRequiredProperties, allowCertificateDownload, allowStatementManagement, allowSystemManagement, d)
  }
