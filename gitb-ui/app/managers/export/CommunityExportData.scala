...
case class CommunityExportData(community: Option[Communities],
                               ...
                               statementDocumentationReportSettings: Option[Option[ConformanceStatementDocumentationReportSettings]],
                               ...
                               organisationPropertyDocumentation: Option[String],
                               systemPropertyDocumentation: Option[String],
                               ...
                               testFlags: Option[List[TestFlags]],
