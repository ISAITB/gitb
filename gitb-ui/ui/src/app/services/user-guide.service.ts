...
export class UserGuideService {
  ...
  initialise() {
    ...
    this.paths['/test/:system_id/:actor_id/:spec_id/execute'] = this.setPath('executeTests/index.html#step-3-test-execution', '', 'validateTestSetup/index.html#step-3-test-execution')
    this.paths['/organisation/systems/:id/info'] = this.setPath('manageConformanceStatements/index.html#view-selected-system-s-information', '', 'validateTestSetup/index.html#view-selected-system-s-information')
    this.paths['/organisation/systems/:id/conformance'] = this.setPath('manageConformanceStatements/index.html#view-your-conformance-statements', '', 'validateTestSetup/index.html#view-your-conformance-statements')
    this.paths['/organisation/systems/:id/conformance/detail/:actor_id/:spec_id'] = this.setPath('manageConformanceStatements/index.html#view-a-conformance-statement-s-details', '', 'validateTestSetup/index.html#view-a-conformance-statement-s-details')
    this.paths['/organisation/systems/:id/conformance/create'] = this.setPath('', 'manageConformanceStatements/index.html#create-a-conformance-statement', 'validateTestSetup/index.html#create-a-conformance-statement')
    this.paths['/organisation/systems/:id/tests'] = this.setPath('testHistory/index.html#search-test-history', '', 'validateTestSetup/index.html#search-test-history')
    this.paths['/organisation/systems'] = this.setPath('manageSystems/index.html', '', 'validateTestSetup/index.html#manage-your-systems')
