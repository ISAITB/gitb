ALTER TABLE `organisationparameters` ADD COLUMN `display_order` SMALLINT DEFAULT 0 NOT NULL;
...
ALTER TABLE `systemparameters` ADD COLUMN `display_order` SMALLINT DEFAULT 0 NOT NULL;
...
ALTER TABLE `parameters` ADD COLUMN `display_order` SMALLINT DEFAULT 0 NOT NULL;
