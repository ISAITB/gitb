...
CREATE TABLE `domains` (
  ...
  `sname` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `fname` varchar(254) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `actors` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `actorId` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `name` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `description` text COLLATE utf8mb4_bin,
  `domain` bigint NOT NULL,
...
CREATE TABLE `endpoints` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `description` text COLLATE utf8mb4_bin,
...
CREATE TABLE `communities` (
  ...
  `support_email` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `selfreg_type` tinyint NOT NULL DEFAULT '1',
  `selfreg_token` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `selfreg_notification` tinyint NOT NULL DEFAULT '0',
  `description` text COLLATE utf8mb4_bin,
  `selfreg_restriction` tinyint NOT NULL DEFAULT '1',
  `selfreg_token_help_text` text COLLATE utf8mb4_bin,
  ...
  `latest_status_label` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_api_key` (`api_key`),
...
CREATE TABLE `conformancesnapshots` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `label` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `snapshot_time` timestamp NOT NULL,
  `community` bigint NOT NULL,
  `api_key` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `public_label` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `communitykeystores` (
  ...
  `keystore_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `keystore_pass` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `key_pass` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `community` bigint NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `communitylabels` (
  ...
  `singular_form` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `plural_form` varchar(254) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `conformancesnapshotdomainparams` (
  ...
  `param_value` varchar(254) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `conformancesnapshotorganisations` (
  ...
  `sname` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `fname` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `api_key` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `snapshot_id` bigint NOT NULL,
  PRIMARY KEY (`id`,`snapshot_id`),
  KEY `cs_org_id` (`id`),
...
CREATE TABLE `conformancesnapshotsystems` (
  ...
  `description` text COLLATE utf8mb4_bin,
  `api_key` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `badge_key` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `snapshot_id` bigint NOT NULL,
  PRIMARY KEY (`id`,`snapshot_id`),
  KEY `cs_sys_id` (`id`),
...
CREATE TABLE `conformancesnapshottestcases` (
  ...
  `fname` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `description` text COLLATE utf8mb4_bin,
  `identifier` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  ...
  `spec_reference` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `spec_description` text COLLATE utf8mb4_bin,
  `spec_link` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `snapshot_id` bigint NOT NULL,
  PRIMARY KEY (`id`,`snapshot_id`),
  KEY `cs_tc_id` (`id`),
...
CREATE TABLE `domainparameters` (
  ...
  `name` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `description` text COLLATE utf8mb4_bin,
  `kind` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `value` mediumblob NOT NULL,
  `domain` bigint NOT NULL,
  `in_tests` tinyint NOT NULL DEFAULT '1',
  `content_type` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `endpointsupportstransactions` (
  `actor` bigint NOT NULL,
  `endpoint` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `transaction` varchar(254) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `organisationparameters` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `test_key` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `description` text COLLATE utf8mb4_bin,
  `use` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `kind` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  ...
  `allowed_values` longtext COLLATE utf8mb4_bin,
  `display_order` smallint NOT NULL DEFAULT '0',
  `depends_on` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `depends_on_value` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `organizations` (
  ...
  `template_name` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `api_key` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `testsuites` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `sname` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `fname` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `version` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `authors` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `original_date` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `modification_date` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `description` text COLLATE utf8mb4_bin,
  `keywords` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `file_name` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `has_documentation` tinyint NOT NULL DEFAULT '0',
  `documentation` longtext COLLATE utf8mb4_bin,
  `identifier` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `is_hidden` tinyint NOT NULL DEFAULT '0',
  `domain` bigint NOT NULL,
  `is_shared` tinyint NOT NULL DEFAULT '0',
  `definition_path` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `spec_reference` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `spec_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `spec_link` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `systemconfigurations` (
  `name` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `parameter` longtext COLLATE utf8mb4_bin,
...
INSERT INTO `systemconfigurations` VALUES ('master_password','$2a$10$TYBt5RUHTeS8suO8Us2DGO9q/.oO2RdLLTdlIj3zmlPrvXyebVzs6','Hash for master password verification'),('session_alive_time','3600','session_alive_time');
...
CREATE TABLE `systems` (
  ...
  `fname` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `description` text COLLATE utf8mb4_bin,
  `version` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `sso_uid` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `sso_email` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `testcases` (
  ...
  `sname` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `fname` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `version` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `authors` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `original_date` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `modification_date` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `description` text COLLATE utf8mb4_bin,
  `keywords` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `type` smallint NOT NULL,
  `path` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `target_actors` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `target_options` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `testsuite_order` smallint NOT NULL,
  `has_documentation` tinyint NOT NULL DEFAULT '0',
  `documentation` longtext COLLATE utf8mb4_bin,
  `identifier` varchar(254) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `testresults` (
  ...
  `sut` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `organization_id` bigint DEFAULT NULL,
  `organization` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `community_id` bigint DEFAULT NULL,
  `community` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `domain_id` bigint DEFAULT NULL,
  `domain` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `specification_id` bigint DEFAULT NULL,
  `specification` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `actor_id` bigint DEFAULT NULL,
  `actor` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `testsuite_id` bigint DEFAULT NULL,
  `testsuite` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `testcase_id` bigint DEFAULT NULL,
  `testcase` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `teststepreports` (
  ...
  `report_path` varchar(254) COLLATE utf8mb4_bin NOT NULL,
...
INSERT INTO `themes` VALUES (1,'ec','European Commission theme.',1,0,'#337ab7','#337ab7','#337ab7','#337ab7','#FFFFFF','#337ab7','#337ab7','#FFFFFF','#0065a2','#074a8b','#FFFFFF','/assets/images/ec.png','#0065a2','#074a8b','/assets/images/gitb.png','inherit','/assets/images/favicon-ec.gif'),(2,'gitb','Default GITB theme.',0,0,'#337ab7','#337ab7','#337ab7','#337ab7','#FFFFFF','#337ab7','#337ab7','#FFFFFF','#171717','#CCCCCC','#FFFFFF','/assets/images/gitb.png','#121214','#CCCCCC','/assets/images/gitb.png','none','/assets/images/favicon.png');
...
CREATE TABLE `triggers` (
  ...
  `name` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `description` text COLLATE utf8mb4_bin,
  `url` varchar(254) COLLATE utf8mb4_bin NOT NULL,
  `event_type` tinyint NOT NULL,
  `operation` varchar(254) COLLATE utf8mb4_bin DEFAULT NULL,
  `active` tinyint NOT NULL DEFAULT '1',
  `latest_result_ok` tinyint DEFAULT NULL,
  `latest_result_output` text COLLATE utf8mb4_bin,
  `community` bigint NOT NULL,
...
CREATE TABLE `testinteractions` (
  `test_session_id` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `test_step_id` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `conformancesnapshotresults` (
  ...
  `test_suite_id` bigint NOT NULL,
  `test_case_id` bigint NOT NULL,
  `test_session_id` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `result` varchar(254) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `output_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `update_time` timestamp NULL DEFAULT NULL,
  `snapshot_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
