...
public class SchematronValidator extends AbstractValidator {
    ...
    public TestStepReportType validate(List<Configuration> configurations, Map<String, DataType> inputs) {
        ...
        if(sch.getSchemaLocation().endsWith(".sch")) {
            schematron  = new SchematronResourceSCH(resource, null, new SchematronResolver(sch.getTestSuiteId(), getTestCaseId()));
        }
        else if(sch.getSchemaLocation().endsWith(".xsl")) {
            schematron  = new SchematronResourceXSLT(resource, null, new SchematronResolver(sch.getTestSuiteId(), getTestCaseId()));
        }
        else {
