...
import com.gitb.remote.RemoteServiceClient;
...
public class RemoteMessagingModuleClient extends RemoteServiceClient implements IMessagingHandler {
	...
	public RemoteMessagingModuleClient(URL serviceURL, Properties callProperties, String sessionId, String testCaseIdentifier, Supplier<ClientConfiguration> clientConfigurationProvider, Consumer<String> sessionEndListener) {
    ...
    public RemoteMessagingModuleClient(URL serviceURL, Properties callProperties) {
        super(serviceURL, callProperties, null, null, null, false);
