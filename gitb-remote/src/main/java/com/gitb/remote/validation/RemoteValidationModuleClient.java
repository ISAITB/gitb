...
public class RemoteValidationModuleClient extends RemoteServiceClient implements IValidationHandler {
	...
	public RemoteValidationModuleClient(URL serviceURL, Properties callProperties, String sessionId, String testCaseIdentifier, ClientConfiguration clientConfiguration) {
		super(serviceURL, callProperties, sessionId, testCaseIdentifier, clientConfiguration);
	}

    public RemoteValidationModuleClient(URL serviceURL, Properties callProperties) {
