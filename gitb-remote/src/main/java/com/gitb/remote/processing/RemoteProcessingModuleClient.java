...
public class RemoteProcessingModuleClient extends RemoteServiceClient implements IProcessingHandler {
    ...
    public RemoteProcessingModuleClient(URL serviceURL, Properties callProperties, String sessionId, String testCaseIdentifier, ClientConfiguration clientConfiguration) {
        super(serviceURL, callProperties, sessionId, testCaseIdentifier, clientConfiguration);
    }

    public RemoteProcessingModuleClient(URL serviceURL, Properties callProperties) {
